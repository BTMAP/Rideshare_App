...
//            show user location
    ...
    private fun setupIconLayerAbove(
        style: Style,
        sourceId: String,
        layerId: String,
        aboveLayer: String
    ...
    private fun setupIconLayerBelow(
        ...
        style.addLayerBelow(
            SymbolLayer(layerId, sourceId)
                .withProperties(iconImage("ICON_ID")), belowLayer
        )
    }
    ...
    private fun getRoute() {
        if (commute.isValid()) {
            ...
            val routeOptions: RouteOptions =
                commute.pairedRouteOptions(getString(R.string.mapbox_access_token))
...
//                    add the returned route to the route line source
    ...
    private fun getPassengerRoute() {
        ...
        val routeOptions: RouteOptions =
            commute.passengerRouteOptions(getString(R.string.mapbox_access_token))
            ...
            if (routes.isNotEmpty()) {
                ...
                mapboxMap?.getStyle {
                    val clickPointSource =
                        it.getSourceAs<GeoJsonSource>("PASSENGER_ROUTE_SOURCE_ID")
                    val routeLineString = LineString.fromPolyline(
                        routes[0].geometry()!!,
                        6
                    )
...
//                }
    ...
    private fun setupLocationSpinner() {
        ...
        val adapter: ArrayAdapter<*> =
            ArrayAdapter<Any?>(this, android.R.layout.simple_spinner_item, locations)
